...
const Page = async () => {
	...
	// only mwajiri users may access this settings page
	if (!identity || identity.role !== "mwajiri") redirect("/sign-in");

	// fetch the mwajiri profile to pre-populate the display name form
	...
	// fall back to a sensible default so the form always has an initial value
